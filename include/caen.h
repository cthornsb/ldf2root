#ifndef CaenGeneral_H
#define CaenGeneral_H
...
class CaenGeneral {
	private:
		CaenV775EventStructure structure;
	...
	public:
		CaenGeneral() : tree(NULL) {}

		bool SetupTree(TTree *tree_);

		bool ReadEvent(unsigned int *data, unsigned int &index, bool verbose=false);
};
